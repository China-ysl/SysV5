                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(data.list).each(function (i, item) {
                            ...
                            tds.eq(2).html(_sexs[item.sex]);
                            tds.eq(3).html(item.birthday);
                            tds.eq(4).html(item.username);
                            tds.eq(5).html(_lfs[item.loginFlag]);//字典JS翻译
                            tds.eq(6).html(item.roleId);
                            tds.eq(7).html(item.createDate);
                            tds.eq(8).html("<a href=\"javascript:cDelete('${_ctx}/user/delete?id=" + item.id + "');\"" +
                                " onclick=\"return confirm('确认删除吗?');\" >删除</a>｜" +
                                "<a href=\"javascript:openDialog('用户更新','${_ui}/user/update.jsp?id=" + item.id + "');\">更新</a>");
                    ...
                    <table width="100%" align="center" border="0">
                        ...
                        <tr>
                            ...
                            <td width="35%">
                                ...
                                <input type="button" value="新增" onclick="openDialog('新增用户', '${_ui}/user/add.jsp')"/>
                            </td>
                        </tr>
